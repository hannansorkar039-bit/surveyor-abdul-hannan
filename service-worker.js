const CACHE_NAME = "sah-pwa-v13-professional-quadrilateral-calculator";
const CORE_ASSETS = [
...
self.addEventListener("fetch", event => {
  ...
  // Calculator: prefer a fresh online version, but keep an offline fallback.
  if (isSameOrigin(url) && (url.pathname.endsWith("/calculator.html") || url.pathname === "/calculator.html")) {
    event.respondWith(
  ...
  // Other core assets remain cache-first for reliable offline use.
