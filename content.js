...
const SITE = {
  ...
  videos: [
    // Example:
    // {title:"ভিডিওর শিরোনাম", description:"সংক্ষিপ্ত বর্ণনা", youtubeId:"YOUR_VIDEO_ID", date:"2026-09-19"}
  ],
  posts: [
    // Example:
  ...
  photos: [
    ...
    {src:"IMG_20260921_065659.jpg", alt:"ভাগ বাটোয়ারা", title:"ভাগ বন্টন", caption:"ভাগ বন্টনের ফিল্ডে তৈরি স্কেচ"},
    {src:"CHH.jpg", alt:"সীমানা নির্ধারণ", title:"ত্রিভুজায়ন", caption:"ত্রিভুজায়ন পদ্ধতিতে সীমানা নির্ধারণ"},
    {src:"CamScanner 12-07-2026 14.52.jpg", alt:"ভাগ বাটোয়ারা", title:"বন্টন", caption:"ভাগ বন্টনের স্কেচ"},
